...
const Banner = () => {
  ...
  return (
    <div className="flex bg-primary rounded-lg px6 sm:px-10 md:px-14 lg:px-12 my-20 md:mx-10">
      {/* Left Side */}
      <div className="flex-1 py-8 sm:py-10 md:py-16 lg:py-24 lg:pl-5">
        <div className="text-xl sm:text-2xl md:text-3xl lg:text-5x1 font-semibold text-white">
          <h1 className="text-2xl font-bold text-white">Book Appointment</h1>
          <p className="text-xl text-gray-200">With 100+ Trusted Doctors</p>
        </div>
