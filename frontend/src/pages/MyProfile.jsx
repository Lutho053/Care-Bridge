...
const MyProfile = () => {
  ...
  return userData && (
    ...
    <div className="max-w-flex flex flex-col gap-2 text-sm">
      ...
      <div className="mt-10">
        {
          isEdit 
          ? <button className="border border-primary px-8 py-2 rounded-full hover:bg-primary hover:text-white transition-all" onClick={updateUserProfileData}> Save Informatiom</button>
